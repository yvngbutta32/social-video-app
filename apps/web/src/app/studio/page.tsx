...
import { apiRequest, getAdaptationPreview, getClipCandidates, type AdaptationRecord, type ApiSocialAccount, type ApiVideo, type ClipCandidate, type GrowthPlan, type LearningSignal, type Readiness, type ReachPlan, type ExperimentScorecard, type PublishingIntentSummary } from '@/lib/api-client';
import {
  ArrowLeft,
  ArrowRight,
  BadgeCheck,
