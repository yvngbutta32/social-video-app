...
import { apiRequest, getAdaptationPreview, type AdaptationRecord, type ApiSocialAccount, type ApiVideo, type GrowthPlan, type LearningSignal, type Readiness, type ReachPlan, type ExperimentScorecard, type PublishingIntentSummary } from '@/lib/api-client';
import {
  ArrowLeft,
  ArrowRight,
  BadgeCheck,
...
export default function GrowthStudioPage() {
  ...
  function submitAdaptationEdit(event: FormEvent<HTMLFormElement>) {
    ...
    const endSeconds = Number(form.get('endSeconds'));
    ...
    adaptationEditMutation.mutate({
      ...
      edit: {
        ...
        composition: { mode: String(form.get('composition')), showSafeZones: form.get('safeZones') === 'on' },
