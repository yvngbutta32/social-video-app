...
import { apiRequest, type ApiSocialAccount, type ApiVideo, type GrowthPlan, type LearningSignal, type Readiness, type ReachPlan, type ExperimentScorecard, type PublishingIntentSummary } from '@/lib/api-client';
import {
  ArrowLeft,
  ArrowRight,
  BadgeCheck,
